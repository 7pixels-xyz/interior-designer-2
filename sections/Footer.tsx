            ...
            >
                ...
                <div className="footer-col">
                    ...
                    <div style={{ marginTop: '1.5rem' }}>
                        <p className="label-small" style={{ color: 'rgba(17, 17, 17,0.35)', marginBottom: '0.3rem' }}>Contact</p>
                ...
                {/* Quick Links */}
                <div className="footer-col">
                    <p className="label-small" style={{ color: 'rgba(17, 17, 17,0.4)', marginBottom: '1.5rem' }}>Quick Links</p>
                ...
                {/* Property Types */}
                <div className="footer-col">
                    <p className="label-small" style={{ color: 'rgba(17, 17, 17,0.4)', marginBottom: '1.5rem' }}>Property Types</p>
                    <ul style={{ listStyle: 'none', display: 'flex', flexDirection: 'column', gap: '0.75rem' }}>
                ...
                <div className="footer-col">
                    <div style={{ marginBottom: '2rem' }}>
                        <p className="label-small" style={{ color: 'rgba(17, 17, 17,0.4)', marginBottom: '1rem' }}>Location</p>
                        <p style={{
                            fontFamily: 'var(--font-sans)',
                            fontSize: '0.85rem',
                            fontWeight: 300,
                    ...
                    <div>
                        <p className="label-small" style={{ color: 'rgba(17, 17, 17,0.4)', marginBottom: '1rem' }}>Socials</p>
