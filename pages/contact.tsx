                ...
                <div className="section-pad">
                    ...
                    <div style={{
                        ...
                        <div style={{ background: 'var(--bg-secondary)', padding: '3rem', borderRadius: '12px' }}>
                            <h3 style={{ fontFamily: 'var(--font-serif)', fontSize: '1.5rem', marginBottom: '1rem' }}>Studio HQ</h3>
                        ...
                        <form style={{ display: 'flex', flexDirection: 'column', gap: '1.5rem' }}>
                            <input type="text" placeholder="Your Name" style={{ background: 'transparent', border: 'none', borderBottom: '1px solid rgba(0,0,0,0.1)', padding: '1rem 0', fontFamily: 'var(--font-sans)', fontSize: '1rem', outline: 'none' }} />
                            <input type="email" placeholder="Your Email" style={{ background: 'transparent', border: 'none', borderBottom: '1px solid rgba(0,0,0,0.1)', padding: '1rem 0', fontFamily: 'var(--font-sans)', fontSize: '1rem', outline: 'none' }} />
                            <textarea placeholder="Project Details" rows={4} style={{ background: 'transparent', border: 'none', borderBottom: '1px solid rgba(0,0,0,0.1)', padding: '1rem 0', fontFamily: 'var(--font-sans)', fontSize: '1rem', outline: 'none', resize: 'vertical' }}></textarea>
